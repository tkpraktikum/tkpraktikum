...
\label{part:appendix}
  ...
  \addcontentsline{toc}{chapter}{C.\quad Application Screenshots}
    ...
    % Figure of ERM goes here
        ...
        \begin{figure}
            \centering
            \fbox{\includegraphics[width=0.9\textwidth]{screenshots/3-submission-menu.png}}
        ...
        \begin{figure}
            \centering
            \fbox{\includegraphics[width=0.9\textwidth]{screenshots/4-review-menu.png}}
            \caption{Review menu}
        ...
        \begin{figure}
            \centering
            \fbox{\includegraphics[width=0.9\textwidth]{screenshots/5-review-overview.png}}
        ...
        \begin{figure}
            \centering
            \fbox{\includegraphics[width=0.9\textwidth]{screenshots/6-conference-menu.png}}
        ...
        \begin{figure}
            \centering
            \fbox{\includegraphics[width=0.9\textwidth]{screenshots/7-conference-overview.png}}
